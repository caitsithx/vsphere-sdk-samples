...
public class RenewTokenSample {
    ...
    * @param cert              {@link X509Certificate} certificate of the user or solution
    * @param durationInSeconds Duration in seconds the token should be kept valid from the
    *                          current time.
